...
if(empty(trim($_POST["contact_no"]))){
    ...
    if(empty($firstname_err) && empty($middlename_err) && empty($lastname_err) && empty($class_err) && empty($gender_err) && empty($dob_err) && empty($contact_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
       $role=$_POST['role']; 
        // Prepare an insert statement
        $sql = "INSERT INTO user_table (role , first_name , middle_name , last_name , class, gender , date_of_birth , contact_no , email_id , password) VALUES (?,?,?,?,?,?,?,?,?,?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "issssssiss",$role,$firstname,$middlename,$lastname,$class,$gender,$dob,$contact,$email,$password);
        ...
        <div class="auth-box bg-dark border-top border-secondary">
          <div>
            <div class="text-center pt-3 pb-3">
              <span class="db"
                ><img src="./assets/images/logoi.png" alt="logo" width="222"
              /></span>
            </div>
            <!-- Form -->
                    ...
                    <div class="row pb-4">
                      <div class="col-12">
                        <div class="input-group mb-3">
                         ...
                         <select name="class" class="form-control form-control-lg  <?php echo (!empty($class_err)) ? 'is-invalid' : ''; ?>"  >
