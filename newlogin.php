...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($email_err) && empty($password_err)){
      //  $role=$_POST['role']; 
        ...
        $sql = "SELECT id,first_name,class,role,email_id, password FROM user_table WHERE email_id = ? AND password = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) > 0){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id,$firstname,$class, $role,$email, $password);
                        ...
                        //     // Password is correct, so start a new session
                          //  session_start();
                            ...
                            if($_SESSION['role']==1){
                                ...
                                window.location.href="mainBody.php"
                                </script>';
                            }
        ...
        <div class="auth-box bg-dark border-top border-secondary">
          <div id="loginform">
            <div class="text-center pt-3 pb-3">
              <span class="db"
                ><img src="./assets/images/logoi.png" alt="logo" width="135"
              /></span>
            </div>
                  <!-- Form -->
                  <?php 
