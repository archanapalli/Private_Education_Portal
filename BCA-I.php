                ...
                <div class="card-body">
                  ...
                  <!-- <div class="table-responsive">
                    ...
                    >
                      ...
                      <?php
                      //List 
                       $sql = "SELECT *FROM `allottime_table` WHERE class='sem-I'";
                       if($result = mysqli_query($link,$sql)){
                        // array
                        $arr1=[];
//                         $rowcount = mysqli_num_rows($result);
//     printf("Total rows in this table: %d", $rowcount);
//     echo "<br>";
//     // $nums = "SELECT SUM(no_session) AS total_session FROM `allottime_table`";
// $sum=0;
...
//               echo "<br>";
          $sizeOf = count($arr1);
// 					echo "Size of an array is : " . $sizeOf;
//           echo "<br>total number of session is : ".$sum;
